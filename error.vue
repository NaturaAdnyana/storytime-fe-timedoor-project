...
<template>
  <NuxtLayout>
    <div class="flex h-[80vh] px-10 md:px-[110px] flex-wrap">
      <div
        class="flex-1 basis-full md:basis-1/2 flex items-center justify-center"
      >
        ...
        <p>
          {{
            error.statusCode === 404
              ...
              : "At least we did better than Coretax."
          }}
        </p>
        <div>
